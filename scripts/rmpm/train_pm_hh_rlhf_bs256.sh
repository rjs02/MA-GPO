...
#SBATCH --gpus=rtx_4090:16
#SBATCH --gres=gpumem:23872m
#SBATCH --time=24:00:00
#SBATCH --mem-per-cpu=8192
#SBATCH --job-name=train_gpm_hh_4b_bs256
#SBATCH --mail-type=BEGIN,END

# Training script for GPM on Anthropic/hh-rlhf dataset
# Using 16x RTX 4090 GPUs with DeepSpeed ZeRO-3 for Qwen3-4B
...
# Effective batch size = MICRO_BATCH_SIZE * ACCUMULATED_GRADIENT * NUM_GPUS = 2 * 8 * 16 = 256

DATE=$(date +%Y%m%d_%H%M%S)

export EXP_NAME="qwen3-4b-gpm-dim${VALUE_HEAD_DIM}-hh-rlhf-bs256-${DATE}"
